...
namespace Org.BouncyCastle.Crypto.Tests
{
		...
		: ITest
    {
        ...
        public virtual ITestResult Perform()
        {
            ...
            if (!resVec4.Equals(resStr))
            {
                return new SimpleTestResult(false, "SHA512 failing standard vector test 5" + SimpleTest.NewLine + "    expected: " + resVec4 + SimpleTest.NewLine + "    got     : " + resStr);
            }
            ...
            {
                return new SimpleTestResult(false, "SHA-512 failing standard vector test 5" + SimpleTest.NewLine + "    expected: " + resVec5 + SimpleTest.NewLine + "    got     : " + resStr);
            }
